...
public class Sales {
	...
	public static ArrayList<Sales> arrayListSales = new ArrayList<Sales>();
	
	
	private Sales(String invoicePayer, String status, String businessTransaction, String basicСlient,
	...
	public static void CreateSales (String invoicePayer, String status, String businessTransaction, String basicСlient,
			String additionalСlient, Long numTransaction, String dateTransaction, String curency, int itemCode,
			String itemNumber, String itemName, int qty, String serialNum, double cost, double costUAH, String party,
			double sumCost, String bString, String notes, String finalSalePriceUAH) {
		
		Sales sales = new Sales(invoicePayer, status, businessTransaction, basicСlient,
